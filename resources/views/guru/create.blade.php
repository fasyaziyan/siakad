        ...
        <div class="card-body">
            <form action="{{ route('guru.store') }}" method="post" enctype='multipart/form-data'>
                ...
                <div class="form-group">
                    <label>NIP</label>
                    <input class="form-control" autocomplete="off" name="nip" value="{{ old('nip') }}">
                    @error('nip')
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" autocomplete="off" name="nama_guru" value="{{ old('nama_guru') }}">
                    @error('nama_guru')
                    <h6 class="text-danger">{{ $message }}</h6>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    <label>Telepon</label>
                    <input class="form-control" autocomplete="off" name="telepon" value="{{ old('telepon') }}">
                    @error('telepon')
                    <h6 class="text-danger">{{ $message }}</h6>
                    @enderror
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Agama</label>
                            <input class="form-control" autocomplete="off" name="agama" value="{{ old('agama') }}">
                            @error('agama')
                            <h6 class="text-danger">{{ $message }}</h6>
                            @enderror
                        </div>
                ...
                <div class="form-group">
                    <label>Email</label>
                    <input class="form-control" autocomplete="off" name="email" type="email" value="{{ old('email') }}">
                    @error('email')
                    <h6 class="text-danger">{{ $message }}</h6>
                    @enderror
                </div>
