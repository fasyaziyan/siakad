...
<ul class="nav nav-tabs">
    <li class="nav-item">
        <a class="nav-link @if (Request::segment(2)=='create' ) active @endif" 
            href="{{ route('raport.create') }}" id="rapot1">Rapot
            Kelas 1</a>
    </li>
    <li class="nav-item">
        <a class="nav-link @if (Request::segment(2)=='create2' ) active @endif"
            href="{{ route('raport.create2') }}" id="rapot2">Rapot Kelas 2</a>
    </li>
    <li class="nav-item">
        <a class="nav-link @if (Request::segment(2)=='create3' ) active @endif"
            href="{{ route('raport.create3') }}" id="rapot3">Rapot Kelas 3</a>
    </li>
</ul>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control js-example-basic-single" name="nisn">
                                ...
                                <option value="{{ $data->nisn }}">{{ $data->nama }} {{ $data->kelas->nama_kelas }}
                                </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control js-example-basic-single" name="id_kuri" id="example-text-input">
                                ...
                                <option value="{{ $data->id_kuri }}">{{ $data->tahun_ajaran }} Semester
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input class="form-control" autocomplete="off" name="n_hadits"
                                value="{{ old('n_hadits') }}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input class="form-control" autocomplete="off" name="n_aqidah"
                                value="{{ old('n_aqidah') }}">
                        </div>
                    </div>
                    <div class="col-md-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input class="form-control" autocomplete="off" name="n_binggris"
                                value="{{ old('n_binggris') }}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label>Matematika</label>
                            <input class="form-control" autocomplete="off" name="n_matematika"
                                value="{{ old('n_matematika') }}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input class="form-control" autocomplete="off" name="n_jasmani"
                                value="{{ old('n_jasmani') }}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input class="form-control" autocomplete="off" name="n_prakarya"
                                value="{{ old('n_prakarya') }}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
...
<script>
	...
	// 		if(menu == "rapot1"){
	// 			$('.grid-margin stretch-card').load('home.php');						
	// 		}else if(menu == "rapot2"){
	// 			$('.grid-margin stretch-card').load('tentang.php');						
	// 		}else if(menu == "rapot3"){
	// 			$('.grid-margin stretch-card').load('tutorial.php');						
	// 		}
	// 	});
 
 
	// 	// halaman yang di load default pertama kali
	// 	$('.rapot1').load('home.php');						
