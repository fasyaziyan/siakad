...
<div class="page-header">
    <h3 class="page-title">
        ...
        </span> Edit Data Kurikulum
    </h3>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Kurikulum</a></li>
            <li class="breadcrumb-item active" aria-current="page">Edit Data Kurikulum</li>
        </ol>
    </nav>
</div>
...
<div class="grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('kurikulum.update', $kurikulum->id_kuri) }}" method="post"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <input class="form-control" autocomplete="off" name="tahun_ajaran1"
                                        value="{{ $tahun_ajaran1 }}">
                                    @error('tahun_ajaran1')
                                ...
                                <div class="col-md-4">
                                    <input class="form-control" autocomplete="off" name="tahun_ajaran2"
                                        value="{{ $tahun_ajaran2 }}">
                                    @error('tahun_ajaran2')
                                    <h6 class="text-danger">{{ $message }}</h6>
                                    @enderror
