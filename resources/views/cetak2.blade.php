...
<body>
    ...
    <table border="1" width="100%" cellspacing="0">
        <thead>
            ...
            <tr style="background-color: #E1E77F;">
                <td align="center" style="font-weight: bold; font-size : 13;">A</td>
            ...
            @if($loop->iteration >=1 && $loop->iteration <=4) <tr>
                ...
                @if ( $data->nilai < $kkm ) <td class="tengah">TIDAK TUNTAS</td>
                    ...
                    @if ($data->nilai >= 90 and $data->nilai <= 100) <td align="center">A</td>
                        ...
                        <tr style="background-color: #E1E77F;">
                            <td align="center" style="font-weight: bold; font-size : 13px;">B</td>
            ...
            <td>
                <table>
                    <tr
                        ...
                        <td class="tebal tengah" width="25px">20</td>
                    </tr>
                    <tr style="border-right: 1px solid black; border-left: 1px solid black;">
                        <td class="tebal">Izin</td>
                        <td class="tebal">:</td>
                        <td class="tebal tengah">20</td>
                    </tr>
                    <tr
                        style="border-bottom: 1px solid black; border-right: 1px solid black; border-left: 1px solid black;">
    ...
    <table>
        ...
        <tr>
            ...
            <td width="200px"> <b style="text-transform: uppercase;"> <u> ZIYAN AL KHAKIM</u></b></td>
